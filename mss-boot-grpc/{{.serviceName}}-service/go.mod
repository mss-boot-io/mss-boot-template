...
replace github.com/mss-boot-io/mss-boot-monorepo/mss-boot/{{.serviceName}}-proto => ../{{.serviceName}}-proto

require (
	github.com/mss-boot-io/mss-boot-monorepo/mss-boot/{{.serviceName}}-proto v0.0.0-00010101000000-000000000000
